...
public class ReflectedProperty extends Property<Object> {
  ...
  static {
    ReflectedProperty.knownGetters = new HashMap<>();
    ReflectedProperty.knownSetters = new HashMap<>();
    ReflectedProperty.knownPaths = new HashMap<>();
  }
    ...
    this.getter = new Function<Object>() {
      ...
      public Object evaluate() {
        Object current = ReflectedProperty.this.getSource();
          for (PathPart curPart : ReflectedProperty.this.parts) {
              try {
