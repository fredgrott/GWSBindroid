...
import com.github.shareme.gwsbindroid.library.trackable.TrackableCollection;
import com.github.shareme.gwsbindroid.library.trackable.Tracker;
...
public class BoundCollectionAdapter<T> implements ListAdapter, SpinnerAdapter {
  ...
  public BoundCollectionAdapter(TrackableCollection<T> data, Class<? extends View> viewType,
    ...
    this.data = data;
    this.presentedData = new TrackableCollection<>(data);
  ...
  private void notifyCollectionChanged() {
    ...
    final List<DataSetObserver> observers = new ArrayList<>(this.observers);
    Runnable toRun = new Runnable() {
      @Override
      public void run() {
        BoundCollectionAdapter.this.presentedData = new TrackableCollection<>(
                BoundCollectionAdapter.this.data);

        if (BoundCollectionAdapter.this.cachedViews != null) {
          Map<T, View> newCache = new HashMap<>();
